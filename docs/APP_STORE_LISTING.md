# BCUTZ - App Store Listing Content
...
```
Find & Book Top Barbers
```

### Promotional Text (170 characters max)
*Can be updated anytime without app review*
```
New: Loyalty rewards program! Earn points on every booking and unlock exclusive discounts. Plus, birthday bonuses for all members! 🎉
```

### Description (4000 characters max)
```
BCUTZ is the modern way to discover and book the best barbers near you. No more waiting in line or playing phone tag – find your perfect barber, book instantly, and show up looking sharp.

WHY BCUTZ?

✂️ DISCOVER TOP BARBERS
Browse verified barbers in your area with real reviews, portfolio photos, and detailed pricing. Filter by location, rating, services, and availability to find your perfect match.

📅 INSTANT BOOKING
Book appointments in seconds, not minutes. See real-time availability, choose your preferred time slot, and confirm with one tap. No phone calls, no hassle.
...
📱 SMART REMINDERS
Never miss an appointment with automatic reminders. Add bookings directly to your calendar with one tap.

🌙 DARK MODE
Easy on the eyes with beautiful light and dark themes. Your choice.
...
FOR BARBERS:
Are you a barber looking to grow your business? BCUTZ helps you reach new clients, manage your schedule, and get paid faster. Visit our website to learn more about joining as a professional.
...
Download BCUTZ today and experience the future of barber bookings!
```

### Keywords (100 characters max, comma-separated)
```
barber,haircut,booking,appointment,grooming,fade,barbershop,hair,mens,styling,beard,trim,shave
```

### Support URL
```
https://bcutz.app/contact
```
...
```
BCUTZ - Book Your Perfect Haircut
```

### Short Description (80 characters max)
```
Find and book the best barbers near you. Instant booking, secure payments, rewards.
```

### Full Description (4000 characters max)
```
BCUTZ is the easiest way to find and book top-rated barbers in your area. Say goodbye to long waits and phone calls – discover your perfect barber, book instantly, and show up looking your best.

🔥 WHY MILLIONS CHOOSE BCUTZ

✂️ DISCOVER AMAZING BARBERS
Browse a curated selection of verified barbers with real reviews, portfolio galleries, and transparent pricing. Use smart filters to find exactly what you're looking for.

⚡ BOOK IN SECONDS
See real-time availability and book your appointment with just a few taps. No phone calls required. Instant confirmation.
...
👔 FOR BARBER PROFESSIONALS
Grow your business with BCUTZ! Reach new clients, manage your calendar, process payments, and build your reputation. Visit our website to join as a professional.

🔒 YOUR PRIVACY MATTERS
We use industry-standard encryption to protect your data. Your personal information is never sold to third parties.

Download BCUTZ now and transform how you book your barber!

Questions? Contact us at support@bcutz.app
```
...
1. **Hero/Browse** - "Find Top Barbers Near You" - Shows barber discovery feed
2. **Barber Profile** - "See Reviews & Portfolios" - Detailed barber page
3. **Booking** - "Book in Seconds" - Time slot selection
4. **Payments** - "Pay Securely" - Payment confirmation
5. **Loyalty** - "Earn Rewards" - Loyalty program tiers
6. **Confirmation** - "You're All Set!" - Booking confirmed screen

### Google Play Screenshots

| Device Type | Size (pixels) | Required |
|-------------|--------------|----------|
| Phone | 1080 x 1920 (min) | 2-8 screenshots |
| 7" Tablet | 1200 x 1920 | Optional |
| 10" Tablet | 1800 x 2560 | Optional |

**Same screenshot content as iOS, optimized for Android dimensions.**
...
| Size | Purpose |
|------|---------|
| 1024 x 1024 | App Store listing |
| 180 x 180 | iPhone (60pt @3x) |
| 167 x 167 | iPad Pro (83.5pt @2x) |
| 152 x 152 | iPad (76pt @2x) |
| 120 x 120 | iPhone (60pt @2x) |
| 87 x 87 | Spotlight iPhone (29pt @3x) |
| 80 x 80 | Spotlight iPad (40pt @2x) |
| 76 x 76 | iPad (76pt @1x) |
| 60 x 60 | iPhone (60pt @1x) |
| 58 x 58 | Settings iPhone (29pt @2x) |
| 40 x 40 | Spotlight (40pt @1x) |
| 29 x 29 | Settings (29pt @1x) |
| 20 x 20 | Notification (20pt @1x) |

### Google Play
| Size | Purpose |
|------|---------|
| 512 x 512 | Play Store icon |
| 192 x 192 | Launcher icon (xxxhdpi) |
| 144 x 144 | Launcher icon (xxhdpi) |
| 96 x 96 | Launcher icon (xhdpi) |
| 72 x 72 | Launcher icon (hdpi) |
| 48 x 48 | Launcher icon (mdpi) |

### Adaptive Icon (Android)
- Foreground: 432 x 432 (with 66dp safe zone)
- Background: 432 x 432 (solid color or pattern)
...
- Or provide images for all device sizes
- Dark mode variant recommended
...
**Content:** Eye-catching banner with app name and key visual
...
### App Store
- 15-30 seconds
- Portrait: 886 x 1920 or 1080 x 1920
...
Email: reviewer@bcutz.app
Password: AppReview2024!

The app requires location permission to show nearby barbers. 
For testing, you can use any location - the app includes demo barbers in all regions.
...
**Developer Name:** BCUTZ Team  
**Email:** support@bcutz.app  
